...
export default function NewsletterForm() {
    ...
    return (
        <form
            className="relative mt-7 max-w-[340px]"
            onSubmit={(event) => {
        ...
        >
            ...
            <button
                ...
                className="absolute top-2 right-2 bottom-2 flex w-11 items-center justify-center rounded-[14px] bg-[linear-gradient(135deg,#13b8ff_0%,#0878e8_100%)] text-white shadow-lg transition hover:scale-105 disabled:opacity-60"
                disabled={processing}
                type="submit"
            >
                {processing ? '…' : '→'}
