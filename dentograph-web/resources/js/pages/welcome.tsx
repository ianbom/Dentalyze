...
import { DETECTION_ACCURACY } from '@/lib/clinical-metrics';
    ...
    return (
        <>
            ...
            <div className="relative min-h-screen w-full overflow-hidden bg-[linear-gradient(180deg,#eef8ff_0%,#edf8ff_18%,#e8f6ff_42%,#edf8ff_68%,#f7fbff_100%)] font-sans text-[#1b1b18]">
                ...
                {/* Header */}
                <header className="fixed top-0 right-0 left-0 z-[999] flex items-center justify-between border-b border-white/30 bg-white/10 px-12 py-5 shadow-[0_8px_30px_rgba(19,184,255,0.08)] backdrop-blur-xl lg:px-20">
                    ...
                    <nav className="hidden items-center gap-12 text-[11px] font-bold tracking-[0.28em] text-[#98a3b5] uppercase lg:flex">
                        {sectionLinks.map(([id, label]) => (
                            <a
                                className={`border-b-2 pb-2 transition ${activeSection === id ? 'border-[#13b8ff] text-[#0878e8]' : 'border-transparent hover:text-[#13b8ff]'}`}
                                href={`#${id}`}
                                key={id}
                            >
                                {label}
                ...
                <main className="relative z-20 px-12 pt-[160px] lg:px-20">
                    <section
                        id="tentang-kami"
                        className="relative min-h-screen scroll-mt-32"
                    >
                        {/* Teks Background */}
                        <div className="pointer-events-none absolute top-[20px] right-0 left-0 z-0 select-none">
                            <h1 className="bg-gradient-to-r from-[#dff6ff] via-[#86d2ff] to-[#2da5f6] bg-clip-text text-center text-[8vw] leading-none font-black tracking-[-0.08em] whitespace-nowrap text-transparent uppercase opacity-70">
                                EVERY SMILE MATTERS
                            </h1>
                        </div>

                        {/* Content Grid - Kita kasih margin top negatif supaya naik menumpuk teks EVERY SMILE MATTERS */}
                        <div className="relative z-20 mt-[-30px] grid grid-cols-1 items-center lg:mt-[-60px] lg:grid-cols-12">
                            {/* Kiri: Deskripsi */}
                            <div className="mt-20 lg:col-span-3 lg:mt-32">
                                {' '}
                                {/* mt dikurangi supaya proporsional saat grid naik */}
                                <div className="rounded-[18px] border border-white/70 bg-white/35 p-8 shadow-sm backdrop-blur-md">
                                    <p className="text-[16px] leading-[1.8] text-[#808999] italic">
                                        "Sistem deteksi dan enumerasi gigi
                                        dewasa otomatis untuk diagnosis karies,
                                        lesi periapikal, dan impaksi."
                                    </p>
                                </div>
                                <div className="mt-12">
                                    <p className="text-[12px] font-black tracking-[0.4em] text-[#c3c8d3] uppercase">
                                ...
                                <Link
                                    href={login()}
                                    className="group mt-10 flex items-center gap-5 rounded-[12px] bg-[linear-gradient(135deg,#13b8ff_0%,#0878e8_100%)] px-11 py-5 text-[14px] font-black text-white shadow-[0_12px_28px_rgba(24,121,230,0.25)] transition-all hover:scale-105 active:scale-95"
                                >
                                    ANALISIS SEKARANG
                                </Link>
                            </div>
                            ...
                            <div className="relative flex justify-center lg:col-span-6">
                                ...
                                <div className="mt-[20px] transition-all lg:mt-[40px]">
                                    <img
                                        src="/asset/images/gigi.png"
                                        alt="Dental AI"
                                        className="animate-gentle-float relative z-30 w-[400px] max-w-none drop-shadow-[0_45px_70px_rgba(19,184,255,0.35)] sm:w-[500px] lg:w-[750px]"
                                    />
                                </div>
                            </div>

                            {/* Kanan: Stats - Sekarang dimulai dari kiri (dekat gigi) */}
                            <div className="mt-20 flex flex-col gap-14 text-left lg:col-span-3 lg:mt-52 lg:items-start lg:pl-10">
                                <div className="flex flex-col items-start">
                                    <div className="flex items-center gap-3 rounded-[10px] border border-white/60 bg-white/40 px-4 py-2 shadow-sm backdrop-blur-md">
                                        {/* Bulatan kecil indikator AI / Collaboration */}
                                        <span className="relative flex h-2 w-2">
                                            <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-blue-400 opacity-75"></span>
                                            <span className="relative inline-flex h-2 w-2 rounded-full bg-blue-500"></span>
                                        </span>
                                        <p className="text-[10px] font-black tracking-[0.25em] text-gray-500 uppercase">
                                    ...
                                    <div className="mt-4 flex items-center gap-4">
                                        ...
                                        <div className="flex flex-col border-l-2 border-[#1c78ea] pl-3">
                                            <h4 className="text-[14px] leading-none font-black tracking-tight text-gray-700">
                                                UNAIR{' '}
                                                <span className="text-[#1c78ea]">
                                                    COLLECTION
                                                </span>
                                            </h4>
                                ...
                                <div className="group">
                                    <h3 className="origin-left text-[40px] leading-none font-black text-[#1c78ea] transition-transform group-hover:scale-105">
                                        {DETECTION_ACCURACY}
                                    </h3>
                                    <p className="mt-2 text-[12px] font-bold tracking-[0.2em] text-[#9ea6b6] uppercase italic">
                                        Akurasi Deteksi{' '}
                                    </p>
                                </div>
                    ...
                    <section
                        id="keunggulan"
                        className="relative z-30 scroll-mt-32 pt-10 pb-28"
                    >
                        {/* Header Section */}
                        <div className="mb-12 grid grid-cols-1 gap-8 lg:grid-cols-12 lg:items-start">
                            <div className="lg:col-span-7">
                                <p className="mb-3 text-[11px] font-black tracking-[0.5em] text-[#49ddd7] uppercase">
                                    KEUNGGULAN DENTALYZE
                                </p>

                                <h2 className="max-w-4xl bg-gradient-to-r from-[#e5f8ff] via-[#8bd7ff] to-[#1592ef] bg-clip-text text-[56px] leading-[0.9] font-black tracking-[-0.07em] text-transparent uppercase lg:text-[84px]">
                                    AI DENTAL CARE
                                </h2>
                            </div>

                            <div className="lg:col-span-5 lg:pt-6">
                                <p className="max-w-xl text-[16px] leading-[1.9] text-[#808999] italic">
                                    Platform analisis radiografi gigi yang
                                    membantu proses kerja klinik menjadi lebih
                                    cepat, rapi, dan mudah dipahami.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-4">
                            ...
                            <div className="group relative min-h-[300px] overflow-hidden rounded-[30px] border border-white/70 bg-white/35 p-7 shadow-[0_18px_45px_rgba(19,184,255,0.08)] backdrop-blur-md transition-all duration-500 hover:-translate-y-2 hover:bg-white/50">
                                ...
                                <div className="relative z-10">
                                    ...
                                    <h3 className="text-[20px] font-black tracking-[-0.04em] text-[#0878e8] uppercase">
                                        Deteksi Cepat
                                    </h3>

                                    <p className="mt-4 text-[15px] leading-[1.8] text-[#808999]">
                                        Membantu membaca temuan radiografi lebih
                                        cepat tanpa alur kerja yang rumit.
                                    </p>

                                    <div className="mt-9 flex items-center gap-3">
                                        <span className="h-2 w-2 rounded-full bg-[#0878e8]" />
                                        <p className="text-[10px] font-black tracking-[0.3em] text-[#9ea6b6] uppercase">
                                            Fast Analysis
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className="group relative min-h-[300px] overflow-hidden rounded-[30px] bg-[linear-gradient(135deg,#20b9ff_0%,#0878e8_100%)] p-7 text-white shadow-[0_24px_55px_rgba(8,120,232,0.26)] transition-all duration-500 hover:-translate-y-2">
                                <div className="absolute -top-16 -right-16 h-48 w-48 rounded-full bg-white/15 blur-3xl transition duration-500 group-hover:scale-125" />
                                ...
                                <div className="relative z-10">
                                    ...
                                    <h3 className="text-[20px] font-black tracking-[-0.04em] text-white uppercase">
                                        Visual Bersih
                                    </h3>

                                    <p className="mt-4 text-[15px] leading-[1.8] text-white/82">
                                        Tampilan hasil dibuat clean agar temuan
                                    ...
                                    <div className="mt-9 rounded-[15px] border border-white/25 bg-white/15 px-4 py-3 backdrop-blur-md">
                                        <p className="text-[10px] font-black tracking-[0.3em] text-white/75 uppercase">
                                            Clean Result
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className="group relative min-h-[300px] overflow-hidden rounded-[30px] bg-[linear-gradient(135deg,#49ddd7_0%,#20bfc7_100%)] p-7 text-white shadow-[0_24px_55px_rgba(73,221,215,0.25)] transition-all duration-500 hover:-translate-y-2">
                                <div className="absolute -top-16 -right-16 h-48 w-48 rounded-full bg-white/18 blur-3xl transition duration-500 group-hover:scale-125" />
                                ...
                                <div className="relative z-10">
                                    ...
                                    <p className="mt-4 text-[15px] leading-[1.8] text-white/85">
                                        Dokter tetap bisa meninjau hasil AI
                                        sebelum dipakai untuk pendukung
                                        diagnosis.
                                    </p>

                                    <div className="mt-9 rounded-[15px] border border-white/25 bg-white/15 px-4 py-3 backdrop-blur-md">
                                        <p className="text-[10px] font-black tracking-[0.3em] text-white/78 uppercase">
                                            Review Ready
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className="group relative min-h-[300px] overflow-hidden rounded-[30px] border border-white/70 bg-[linear-gradient(135deg,rgba(255,255,255,0.45)_0%,rgba(216,230,255,0.32)_100%)] p-7 shadow-[0_18px_45px_rgba(19,184,255,0.08)] backdrop-blur-md transition-all duration-500 hover:-translate-y-2 hover:bg-white/50">
                                <div className="absolute -top-16 -right-16 h-44 w-44 rounded-full bg-[#49ddd7]/15 blur-3xl transition duration-500 group-hover:scale-125" />
                                ...
                                <div className="relative z-10">
                                    ...
                                    <p className="mt-4 text-[15px] leading-[1.8] text-[#808999]">
                                        ...
                                        berulang agar dokumentasi lebih hemat
                                        waktu.
                                    </p>
                    ...
                    <section
                        id="layanan"
                        className="relative z-30 scroll-mt-32 overflow-hidden rounded-[38px] border border-white/60 bg-[linear-gradient(135deg,rgba(255,255,255,0.38)_0%,rgba(214,241,255,0.42)_45%,rgba(232,250,255,0.28)_100%)] px-8 pt-14 pb-16 shadow-[0_24px_70px_rgba(19,184,255,0.08)] backdrop-blur-md lg:px-10 lg:pt-16 lg:pb-20"
                    >
                        {/* Header */}
                        <div className="mb-14 text-center">
                            <p className="mb-3 text-[11px] font-black tracking-[0.45em] text-[#49ddd7] uppercase">
                                LAYANAN DENTALYZE
                            </p>

                            <h2 className="mx-auto max-w-5xl bg-gradient-to-r from-[#dff6ff] via-[#8bd7ff] to-[#1592ef] bg-clip-text text-[46px] leading-[0.9] font-black tracking-[-0.07em] text-transparent uppercase lg:text-[78px]">
                                DETECTION SERVICES
                            </h2>

                            <p className="mx-auto mt-4 max-w-3xl text-[16px] leading-[1.9] text-[#808999] italic">
                                Analisis radiografi gigi dewasa yang mencakup
                                enumerasi gigi serta deteksi berbagai kelainan
                                penting secara lebih visual, cepat, dan mudah
                                dipahami.
                            </p>
                        </div>
                        ...
                        <div className="space-y-5 lg:hidden">
                            ...
                            <div className="rounded-[30px] border border-white/70 bg-white/35 p-8 shadow-[0_18px_45px_rgba(19,184,255,0.08)] backdrop-blur-md">
                                <div className="relative flex min-h-[260px] items-center justify-center">
                                    <div className="absolute top-1/2 left-1/2 h-[280px] w-[280px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-white/45 blur-[80px]" />
                                    <div className="absolute top-1/2 left-1/2 h-[230px] w-[230px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#49ddd7]/18 blur-[70px]" />
                                    <div className="absolute top-1/2 left-1/2 h-[210px] w-[210px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#13b8ff]/14 blur-[60px]" />
                            ...
                            <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
                                <div className="rounded-[26px] border border-white/70 bg-white/40 p-6 shadow-[0_14px_35px_rgba(19,184,255,0.06)] backdrop-blur-md">
                                    ...
                                    <h3 className="text-[18px] font-black tracking-[-0.03em] text-[#0878e8] uppercase">
                                        Enumerasi Gigi Dewasa
                                    </h3>
                                    <p className="mt-3 text-[15px] leading-[1.75] text-[#7f8b9d]">
                                        Mengidentifikasi dan menghitung gigi
                                        dewasa secara otomatis dari radiografi
                                        panoramik.
                                    </p>
                                </div>
                                ...
                                <div className="rounded-[26px] bg-[linear-gradient(135deg,#1fb8ff_0%,#0878e8_100%)] p-6 text-white shadow-[0_18px_45px_rgba(8,120,232,0.22)]">
                                    ...
                                    <h3 className="text-[18px] font-black tracking-[-0.03em] text-white uppercase">
                                        Karies
                                    </h3>
                                    <p className="mt-3 text-[15px] leading-[1.75] text-white/82">
                                        Membantu menemukan area gigi yang
                                        dicurigai mengalami karies.
                                    </p>
                                </div>
                                ...
                                <div className="rounded-[26px] border border-white/70 bg-white/40 p-6 shadow-[0_14px_35px_rgba(19,184,255,0.06)] backdrop-blur-md">
                                    ...
                                    <p className="mt-3 text-[15px] leading-[1.75] text-[#7f8b9d]">
                                        Membantu mendeteksi indikasi hilangnya
                                        struktur akar gigi.
                                    </p>
                                </div>
                                ...
                                <div className="rounded-[26px] border border-white/70 bg-white/40 p-6 shadow-[0_14px_35px_rgba(19,184,255,0.06)] backdrop-blur-md">
                                    ...
                                    <p className="mt-3 text-[15px] leading-[1.75] text-[#7f8b9d]">
                                        Mengidentifikasi dugaan lesi di area
                                        sekitar apeks akar gigi.
                                    </p>
                                </div>
                                ...
                                <div className="rounded-[26px] bg-[linear-gradient(135deg,#49ddd7_0%,#21bfc6_100%)] p-6 text-white shadow-[0_18px_45px_rgba(73,221,215,0.22)]">
                                    ...
                                    <p className="mt-3 text-[15px] leading-[1.75] text-white/84">
                                        Membantu mengenali gigi yang tidak
                                        erupsi normal atau tertahan.
                                    </p>
                                </div>
                                ...
                                <div className="rounded-[26px] border border-white/70 bg-[linear-gradient(135deg,rgba(255,255,255,0.48)_0%,rgba(216,230,255,0.34)_100%)] p-6 shadow-[0_14px_35px_rgba(19,184,255,0.06)] backdrop-blur-md">
                                    ...
                                    <p className="mt-3 text-[15px] leading-[1.75] text-[#7f8b9d]">
                                        Menampilkan hasil analisis dengan
                                        penandaan visual yang lebih mudah
                                        dibaca.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div className="relative hidden h-[920px] lg:block">
                            ...
                            <div className="absolute top-[450px] left-1/2 z-20 -translate-x-1/2 -translate-y-1/2">
                                <div className="relative flex h-[470px] w-[390px] items-center justify-center">
                                    {/* glow only, no card */}
                                    <div className="absolute top-1/2 left-1/2 -z-10 h-[420px] w-[420px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-white/45 blur-[120px]" />
                                    <div className="absolute top-1/2 left-1/2 -z-10 h-[340px] w-[340px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#49ddd7]/22 blur-[105px]" />
                                    <div className="absolute top-1/2 left-1/2 -z-10 h-[280px] w-[280px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#13b8ff]/16 blur-[90px]" />
                            ...
                            {/* Left Top */}
                            <div className="absolute top-0 left-[110px] z-10 w-[275px] overflow-hidden rounded-[30px] border border-white/70 bg-white/40 p-5 shadow-[0_14px_32px_rgba(19,184,255,0.06)] backdrop-blur-md transition duration-300 hover:-translate-y-2 hover:bg-white/52">
                                ...
                                <h3 className="text-[16px] font-black tracking-[-0.03em] text-[#0878e8] uppercase">
                                    Enumerasi Gigi Dewasa
                                </h3>
                                <p className="mt-3 text-[14px] leading-[1.7] text-[#7f8b9d]">
                                    Mengidentifikasi dan menghitung gigi dewasa
                                    otomatis.
                                </p>
                            </div>

                            {/* Left Middle */}
                            <div className="absolute top-[310px] left-[110px] z-10 w-[275px] overflow-hidden rounded-[30px] bg-[linear-gradient(135deg,#1fb8ff_0%,#0878e8_100%)] p-5 text-white shadow-[0_18px_40px_rgba(8,120,232,0.22)] transition duration-300 hover:-translate-y-2">
                                <div className="mb-5 flex h-[135px] items-center justify-center overflow-hidden">
                                    <img
                                        src="/asset/images/karies.png"
                                        alt="Karies"
                                ...
                                <h3 className="text-[16px] font-black tracking-[-0.03em] text-white uppercase">
                                    Karies
                                </h3>
                                <p className="mt-3 text-[14px] leading-[1.7] text-white/82">
                                    Membantu menemukan area gigi yang dicurigai
                                    mengalami karies.
                                </p>
                            </div>

                            {/* Left Bottom */}
                            <div className="absolute top-[620px] left-[110px] z-10 w-[275px] overflow-hidden rounded-[30px] border border-white/70 bg-white/40 p-5 shadow-[0_14px_32px_rgba(19,184,255,0.06)] backdrop-blur-md transition duration-300 hover:-translate-y-2 hover:bg-white/52">
                                <div className="mb-5 flex h-[135px] items-center justify-center overflow-hidden">
                                    <img
                                        src="/asset/images/resorpsiakar.png"
                                        alt="Resorpsi akar"
                            ...
                            {/* Right Top */}
                            <div className="absolute top-0 right-[110px] z-10 w-[275px] overflow-hidden rounded-[30px] border border-white/70 bg-white/40 p-5 shadow-[0_14px_32px_rgba(19,184,255,0.06)] backdrop-blur-md transition duration-300 hover:-translate-y-2 hover:bg-white/52">
                                <div className="mb-5 flex h-[135px] items-center justify-center overflow-hidden">
                                    <img
                                        src="/asset/images/lesi.png"
                                        alt="Lesi periapikal"
                                ...
                                <p className="mt-3 text-[14px] leading-[1.7] text-[#7f8b9d]">
                                    Mengidentifikasi dugaan lesi di sekitar
                                    apeks akar gigi.
                                </p>
                            </div>

                            {/* Right Middle */}
                            <div className="absolute top-[310px] right-[110px] z-10 w-[275px] overflow-hidden rounded-[30px] bg-[linear-gradient(135deg,#49ddd7_0%,#21bfc6_100%)] p-5 text-white shadow-[0_18px_40px_rgba(73,221,215,0.22)] transition duration-300 hover:-translate-y-2">
                                <div className="mb-5 flex h-[135px] items-center justify-center overflow-hidden">
                                    <img
                                        src="/asset/images/impaksi.png"
                                        alt="Impaksi"
                                ...
                                <p className="mt-3 text-[14px] leading-[1.7] text-white/84">
                                    Membantu mengenali gigi yang tidak erupsi
                                    normal atau tertahan.
                                </p>
                            </div>

                            {/* Right Bottom */}
                            <div className="absolute top-[620px] right-[110px] z-10 w-[275px] overflow-hidden rounded-[30px] border border-white/70 bg-[linear-gradient(135deg,rgba(255,255,255,0.48)_0%,rgba(216,230,255,0.34)_100%)] p-5 shadow-[0_14px_32px_rgba(19,184,255,0.06)] backdrop-blur-md transition duration-300 hover:-translate-y-2 hover:bg-white/52">
                                <div className="mb-5 flex h-[135px] items-center justify-center overflow-hidden">
                                    <img
                                        src="/asset/images/visualisasi.png"
                                        alt="Visualisasi hasil"
                                ...
                                <p className="mt-3 text-[14px] leading-[1.7] text-[#7f8b9d]">
                                    Menampilkan hasil analisis dengan penandaan
                    ...
                    <section
                        id="verifikasi"
                        className="relative z-30 -mx-12 mt-20 scroll-mt-24 overflow-hidden px-12 py-20 lg:-mx-20 lg:px-20 lg:py-24"
                    >
                        <div className="relative z-10 grid grid-cols-1 items-center gap-16 lg:grid-cols-12">
                                ...
                                <div className="relative mx-auto flex min-h-[460px] max-w-[460px] items-center justify-center">
                                    ...
                                    <div className="relative z-20 w-full overflow-hidden rounded-[42px] border border-white/70 bg-white/65 p-5 shadow-[0_30px_70px_rgba(19,184,255,0.14)] backdrop-blur-xl">
                                        <div className="relative overflow-hidden rounded-[34px] bg-[linear-gradient(135deg,#0878e8_0%,#13b8ff_48%,#49ddd7_100%)] p-7 text-white">
                                            ...
                                            {/* Scanner Line */}
                                            <div className="absolute top-[38%] right-0 left-0 h-[2px] bg-gradient-to-r from-transparent via-white to-transparent shadow-[0_0_18px_rgba(255,255,255,0.9)]" />
                                            ...
                                            <div className="relative z-10 mb-10 flex items-center justify-between">
                                                ...
                                                <div className="text-right">
                                                    <p className="text-[10px] font-black tracking-[0.28em] text-white/80 uppercase">
                                                        Dental Verify
                                                    </p>
                                            ...
                                            <div className="relative z-10 flex flex-col items-center justify-center py-10">
                                                {/* Floating Checks */}
                                                <div className="absolute top-4 left-4 rounded-full bg-white/16 p-2 backdrop-blur-md">
                                                    <svg
                                                ...
                                                <div className="absolute top-16 right-3 rounded-full bg-white/16 p-2 backdrop-blur-md">
                                                    <svg
                                                ...
                                                <div className="absolute right-10 bottom-4 rounded-full bg-white/16 p-2 backdrop-blur-md">
                                                    <svg
                                                        className="h-5 w-5 text-white"
                                                        fill="none"
                                                        viewBox="0 0 24 24"
                                                ...
                                                <div className="relative rounded-[30px] bg-white p-6 shadow-[0_24px_50px_rgba(0,80,130,0.25)]">
                                                    <svg
                                                        className="h-[116px] w-[116px] text-[#0878e8]"
                                                        fill="none"
                                                        viewBox="0 0 24 24"
                                                        stroke="currentColor"
                                                        strokeWidth="1.8"
                                                    ...
                                                    <div className="absolute -top-1 -left-1 h-6 w-6 rounded-tl-xl border-t-4 border-l-4 border-[#49ddd7]" />
                                                    <div className="absolute -top-1 -right-1 h-6 w-6 rounded-tr-xl border-t-4 border-r-4 border-[#49ddd7]" />
                                                    <div className="absolute -bottom-1 -left-1 h-6 w-6 rounded-bl-xl border-b-4 border-l-4 border-[#49ddd7]" />
                                                    <div className="absolute -right-1 -bottom-1 h-6 w-6 rounded-br-xl border-r-4 border-b-4 border-[#49ddd7]" />
                                                </div>
                                                ...
                                                <div className="mt-8 inline-flex items-center gap-3 rounded-full border border-white/25 bg-white/18 px-5 py-2 backdrop-blur-md">
                                                    ...
                                                    <p className="text-[10px] font-black tracking-[0.28em] text-white/85 uppercase">
                                                        Live Verifying
                                                    </p>
                                                </div>
                                            </div>
                                            ...
                                            <div className="relative z-10 rounded-[24px] border border-white/20 bg-white/16 p-4 backdrop-blur-md">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        <p className="text-[9px] font-black tracking-[0.22em] text-white/55 uppercase">
                                                            Patient Report
                                                        </p>
                                    ...
                                    {/* Floating Badge */}
                                    <div className="absolute top-[35%] -right-6 z-30 hidden items-center gap-3 rounded-[22px] border border-white/70 bg-white/80 px-5 py-4 shadow-[0_20px_45px_rgba(19,184,255,0.16)] backdrop-blur-md lg:flex">
                                        ...
                                        <p className="text-[12px] font-black tracking-[0.08em] text-[#0878e8] uppercase">
                                            Real-time Sync
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className="lg:col-span-7 lg:pl-10">
                                <div className="mb-8">
                                    <p className="mb-4 inline-flex rounded-full border border-white/70 bg-white/45 px-5 py-2 text-[11px] font-black tracking-[0.35em] text-[#49ddd7] uppercase backdrop-blur-md">
                                        Verifikasi Laporan
                                    </p>

                                    <h2 className="max-w-4xl bg-gradient-to-r from-[#dff6ff] via-[#86d2ff] to-[#0878e8] bg-clip-text text-[48px] leading-[0.92] font-black tracking-[-0.06em] text-transparent uppercase lg:text-[78px]">
                                        Hasil Analisis Terverifikasi
                                    </h2>

                                    <p className="mt-6 max-w-2xl text-[16px] leading-[1.9] text-[#808999] italic">
                                        Setiap laporan hasil analisis dapat
                                        dilengkapi identitas digital agar data
                                        lebih mudah ditinjau, dicek ulang, dan
                                        digunakan sebagai dokumentasi klinis
                                        yang rapi.
                                    </p>
                                </div>
                                ...
                                <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
                                        ...
                                        <div className="mb-5 flex h-12 w-12 items-center justify-center rounded-[16px] bg-[#13b8ff]/10 text-[#0878e8]">
                                            ...
                                            >
                                                <path
                                                    strokeLinecap="round"
                                                    strokeLinejoin="round"
                                                    d="M4 4h6v6H4V4zm10 0h6v6h-6V4zM4 14h6v6H4v-6zm12 0h4v4h-4v-4z"
                                                />
                                            </svg>
                                        </div>

                                        <h3 className="text-[19px] font-black tracking-[-0.03em] text-[#0878e8] uppercase">
                                            Quick Verification
                                        </h3>

                                        <p className="mt-3 text-[15px] leading-[1.75] text-[#808999]">
                                            Pindai kode unik pada laporan untuk
                                            membantu proses validasi data secara
                                            cepat.
                                        </p>
                                    </div>
                                    ...
                                    <div className="rounded-[26px] bg-[linear-gradient(135deg,#49ddd7_0%,#20bfc7_100%)] p-6 text-white shadow-[0_18px_45px_rgba(73,221,215,0.22)]">
                                        ...
                                        <h3 className="text-[19px] font-black tracking-[-0.03em] text-white uppercase">
                                            Secure Record
                                        </h3>

                                        <p className="mt-3 text-[15px] leading-[1.75] text-white/86">
                                            Membantu menjaga integritas
                                            dokumentasi hasil analisis agar
                            ...
                            <div className="grid grid-cols-1 gap-14 md:grid-cols-2 xl:grid-cols-[1.2fr_0.9fr_0.9fr_1.1fr]">
                                ...
                                <div className="lg:col-span-1">
                                    ...
                                    <p className="mt-5 max-w-[320px] text-[15px] leading-[1.8] text-[#808999]">
                                        ...
                                        membantu analisis radiografi gigi
                                        dewasa, enumerasi gigi, serta deteksi
                                        kelainan secara lebih cepat dan rapi.
                                    </p>
                            ...
                            <div className="mt-16 border-t border-[#0878e8]/10 pt-8">
                                <div className="flex flex-col items-center justify-between gap-5 text-[14px] text-[#9ea6b6] md:flex-row">
                                    <p>
                                        ...
                                        Disease Detection and Analysis System.
                                        All rights reserved.
                                    </p>
