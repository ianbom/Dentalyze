...
test('dentograph form requests expose expected validation fields', function (string $class, array $fields) {
    ...
    'store patient' => ['App\Http\Requests\Patients\StorePatientRequest', ['nik', 'name', 'email', 'phone', 'birth_place', 'birth_date', 'address', 'age', 'gender', 'return_to', 'faskes_id']],
    'update patient' => ['App\Http\Requests\Patients\UpdatePatientRequest', ['name', 'email', 'phone', 'birth_place', 'birth_date', 'address', 'age', 'gender', 'faskes_id']],
